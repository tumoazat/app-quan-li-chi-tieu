...
class _AddTransactionSheetState extends ConsumerState<AddTransactionSheet> {
  ...
  Future<void> _saveTransaction() async {
    ...
    try {
      ...
      // When editing, the _amount might already be negative, so we use abs()
      // to ensure we don't make it positive by mistake.
      final transactionAmount = _type == TransactionType.expense ? -_amount.abs() : _amount.abs();
